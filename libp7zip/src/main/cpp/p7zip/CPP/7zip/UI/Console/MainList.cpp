    ...
    */
    ...
    if (options.Command.CommandType == NCommandType::kInfo) {
        ...
        if (hresultMain == S_OK)
            if (isExtractGroupCommand) {
                ...
                */
                ...
                LOGI("Extract Group, retCode = %d", retCode);
            } else {
                UInt64 numErrors = 0;
                ...
                LOGV("ListArchive, hresultMain = %d", hresultMain);
            }
        ...
        */
        ...
        LOGI("Update group, retCode = %d", retCode);
#ifdef ENV_UNIX
        if (uo.SfxMode) {
